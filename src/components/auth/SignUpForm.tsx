...
export default function SignUpForm() {
  ...
  const handleTwitterSignup = async () => {
    try {
      ...
      console.log('🔵 [Twitter OAuth] Initiating sign up...');
      ...
      if (error) {
        ...
        if (error.message.includes('popup_closed_by_user')) {
          ...
          setError('X signup failed: OAuth configuration issue. Please check Supabase Twitter provider settings.');
        } else {
  ...
  return (
    <div className="flex flex-col flex-1">
      <div className="w-full max-w-md pt-10 mx-auto">
        <div className="inline-flex items-center text-sm text-gray-700 dark:text-gray-300 font-semibold">
          Infinite Money Glitch Dashboard
        </div>
      </div>
